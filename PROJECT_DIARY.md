...
**节点**: Bug修复 - AI对话人物画像接入  
**状态**: ✅ 已完成  
**开始时间**: 2026-04-06 20:40  
**完成时间**: 2026-04-06 21:00  
**工时**: 20分钟

### 修复内容
- [x] 修复 AI 对话使用硬编码人物画像的问题
- [x] `sendChatMessage` 支持传入 `characterId` 参数
- [x] 自动从 `localDb` 获取当前人物的画像数据
- [x] 3处调用点更新，确保对话使用真实人物性格

### 修改文件
- `src/lib/chat.ts` - 添加人物画像获取逻辑
- `src/app/api/chat/route.ts` - 接收并使用画像参数
- `src/app/story/page.tsx` - 传入 characterId
